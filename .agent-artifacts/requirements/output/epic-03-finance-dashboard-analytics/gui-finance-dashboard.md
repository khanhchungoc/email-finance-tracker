...
| **Settings Modal: Connect Microsoft** | Auth Action Button | Initiates 1-click Microsoft OAuth 2.0 flow opening system browser with `Mail.Read` scope.<br>- Default: Microsoft logo + "Connect with Microsoft 365".<br>- States: Default, Hover, Loading. | - Required: Yes<br>- Rules: Browser opens OAuth URL on click; listens on local loopback `127.0.0.1:<port>`. |
| **Timeframe Filter Dropdown** | Select Dropdown | Controls the date window for KPI calculations and charts.<br>- Default: "This Month"<br>- Options: "This Month", "Last Month", "Last 3 Months", "Year to Date", "All Time".<br>- States: Enabled. | - Required: Yes<br>- Rules: Triggers instant local recalculation of all KPI cards and charts on change. |
