...
- `references/` - Source inventories, external links, excerpts, and citation anchors.
- `_templates/` - Starter templates for durable project context.
...
Do not store generated BA deliverables in this folder. After the user confirms a knowledge-base update, distill only stable reusable facts from `../requirements/output/` into `wiki/`, `solution-context/`, `glossary/`, or `references/`.
