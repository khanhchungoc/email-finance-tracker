...
* Project overview and engagement context.
* Client, vendor, third-party, approver, SME, delivery, BA, QA, architecture, and support roles.
* In-scope, out-of-scope, assumptions, exclusions, constraints, dependencies, and estimation boundaries.
* Delivery model, governance, ceremonies, sprint/release approach, acceptance, handover, support, and ways of working.
